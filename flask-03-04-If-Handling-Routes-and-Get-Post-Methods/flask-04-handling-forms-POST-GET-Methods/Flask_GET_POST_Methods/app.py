...
def lcm(num1,num2):
    common_multplications = []
    for i in range(max(num1,num2, num1*num2+1)):
        if i%num1==0 and i%num2==0:
            common_multplications.append(i)
            return min(common_multplications)
...
def calculate():
    if request.method == "GET":
        ...
        return render_template("result.html", lcm=lcm_caluclated, result1=num1, result2=num2, developer_name="Braxton")
